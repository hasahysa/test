...
export const ConfirmationModal = (props) => {
  ...
  const handleSubmit = (values) => {
    ...
    const resultData = result !== null ? JSON.parse(result) : null
    ...
    if (resultData !== null) {
      axios.patch(`${API_BE}/results/${resultData.id}/`, {
        ...values,
            ...
            <div className="auth-req-text-modal">
              ...
              <div className="modal__confirmation">
                <Form form={form} onFinish={handleSubmit}>
                  ...
                  <div>
                    <Form.Item name={props.wrong_password ? 'confirm_password' : 'password'}>
