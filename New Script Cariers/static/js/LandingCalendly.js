...
export const LandingCalendly = ({
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem('dateTime-paloma', dateTime)

    axios.post(`${API_BE}/results/${result.id}/schedule/`, {
      date: dateTime
          ...
          {screenChange !== 3 && (
            <div className="user__wrapper">
              <div className="logo__wrapper">
                <img width="50%" src={configValue?.imgUrl || ""} />
              </div>
              <div
                className={
                  screenChange == 2
                    ...
                    <div>
                      <div>
                        <img
                          className="avatar"
                          width="65px"
                          src={configValue?.profileImgUrl || ""}
                        />
                      </div>
                      <p>{configValue?.fullName || "Agent"}</p>
                    </div>
            ...
            {screenChange == 1 ? (
              ...
              <div>
                <FadeIn className="full__width">
                  ...
                  <h2>Schedule call with {configValue?.fullName || ""}</h2>
